...
exports.logoutActionAPI = exports.loginActionAPI = void 0;
...
var USER_DATA_LOGIN = 'USER_DATA_LOGIN';

var loginActionAPI = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(email, password) {
    var apiLogin, res, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            apiLogin = '/api/v1/users/login';
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.post(apiLogin, {
              email: email,
              password: password
            });
  ...
  return function loginActionAPI(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.loginActionAPI = loginActionAPI;

var logoutActionAPI = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var apiLogout, res, data;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            apiLogout = '/api/v1/users/logout';
            _context2.prev = 1;
            _context2.next = 4;
            return _axios.default.get(apiLogout);
          ...
          case 4:
            ...
            if (data && data.Code === 0) {
              ...
              if (location.pathname === '/account' || location.pathname === '/submit-update-user') {
                location.assign('/');
  ...
  return function logoutActionAPI() {
    return _ref2.apply(this, arguments);
  };
}();

exports.logoutActionAPI = logoutActionAPI;
...
var displayMap = function displayMap(locations) {
  if (!!locations) {
    mapboxgl.accessToken = 'pk.eyJ1IjoidHVuZ2FuaDI1MiIsImEiOiJja2I1enllaG8xMXJ2MnFueHVqaXVmdTFyIn0.Jn3RlAehU0-ay9FVSKU3fA';
    var map = new mapboxgl.Map({
      container: 'map',
      // container is id html
    ...
    locations.forEach(function (loc) {
      ...
      new mapboxgl.Popup({
        offset: 30
      }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend map bounds to include location
...
exports.updateUserActionApi = void 0;
...
var updateUserActionApi = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(type, dataUpdate) {
    var apiUpdateUserInfo, apiUpdateCurrentPassword, apiUrl, res, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
  ...
  return function updateUserActionApi(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateUserActionApi = updateUserActionApi;
...
var stripe = Stripe('pk_test_51Gz3IlLvhL2UfZ6F4wpojxKngTr0k6oXzAGOyrAU9LWTHmmSz4FFxiszKAiJBwQQdf5quNS57aditl7iL4iY3OgZ00gupMqLP9');
...
if (DOM_Update_User_Info_Form) {
  DOM_Update_User_Info_Form.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 8;
              return (0, _updateSettings.updateUserActionApi)('info', formData);
...
if (DOM_Update_User_Password_Form) {
  DOM_Update_User_Password_Form.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return (0, _updateSettings.updateUserActionApi)('password', {
